...
(deftype MemoryDatastore [store]
  ...
  (ds-count-by-kind [this kind filters options] (count (find-records-by-kind this kind filters nil nil nil)))
  (ds-count-all-kinds [this filters options] (count (find-records this filters nil nil nil)))
