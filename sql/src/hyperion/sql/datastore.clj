...
(deftype SqlDatastore [query-executor query-builder]
  ...
  (ds-count-by-kind [this kind filters options] (count-records-by-kind this kind filters))
  (ds-count-all-kinds [this filters options] (count-records-by-all-kinds this filters))
  ...
  (ds-find-all-kinds [this filters sorts limit offset options] (find-records-by-all-kinds this filters sorts limit offset))
